...
SECRET_KEY = 'django-insecure-pk_r6_x@-@96ga2%ikec4+tec8kyf+l4@r&0^5385b#d06k=-%'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "khayru-rafa-footballnews.pbp.cs.ui.ac.id", "10.0.2.2"]

CSRF_TRUSTED_ORIGINS = [
    "<https://khayru-rafa-footballnews.pbp.cs.ui.ac.id>"
]
